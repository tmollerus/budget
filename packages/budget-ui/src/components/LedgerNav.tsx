  ...
  const getMonthNavFor = (month: number) => {
    return (
      <div
        ...
        onClick={(e) => scrollToMonth(e, `month-${month}`)}
      >
  ...
  return (
    <div className={classes.ledgerNav}>
      <div className={classes.yearNav} data-testid="yearNav">
        <a
          href={`${APP.ROUTES.LEDGER}/${prevBudgetYear}`}
          data-testid="yearNavPrev"
          onClick={(e) => {
            changeBudgetYear(e, prevBudgetYear);
          }}
        >
        ...
        <a
          href={`${APP.ROUTES.LEDGER}/${nextBudgetYear}`}
          data-testid="yearNavNext"
          onClick={(e) => {
            changeBudgetYear(e, nextBudgetYear);
          }}
        >
      ...
      <div className={[classes.yearNav, classes.last].join(' ')}>&nbsp;</div>
    </div>
  );
};
